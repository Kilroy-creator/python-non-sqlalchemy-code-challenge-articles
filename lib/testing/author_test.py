...
class TestAuthor:
    ...
    def test_topic_areas(self):
        ...
        assert len(author_1.topic_areas()) == 2 # type: ignore
        assert set(author_1.topic_areas()) == {"Fashion", "Architecture"}# type: ignore
    ...
    def test_topic_areas_are_unique(self):
        ...
        assert len(set(author_1.topic_areas())) == len(author_1.topic_areas())#  type: ignore
        assert len(author_1.topic_areas()) == 2 #  type: ignore
        assert "Fashion" in author_1.topic_areas()#  type: ignore
        assert "Architecture" in author_1.topic_areas()#  type: ignore
