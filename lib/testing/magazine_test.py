...
class TestMagazine:
    ...
    def test_contributing_authors(self):
        ...
        assert author_1 in magazine_1.contributing_authors()#  type: ignore
        assert author_2 not in magazine_1.contributing_authors()#  type: ignore
        assert all(isinstance(author, Author) for author in magazine_1.contributing_authors())#  type: ignore
